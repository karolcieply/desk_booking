    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab_workstation', models.CharField(default='', max_length=30)),
                ('operator_licence', models.CharField(default='', max_length=30)),
                ('additional_info', models.CharField(default='', max_length=50)),
